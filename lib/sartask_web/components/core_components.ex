defmodule SartaskWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SartaskWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SartaskWeb.Gettext, "errors", msg, opts)
    end
  end
